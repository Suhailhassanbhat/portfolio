...
var svg = d3.select('#wiretap').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
function ready(datapoints) {
  ...
  }).attr('height', 20).attr('x', 0).attr('y', function (d) {
    return yPositionScale(d.State);
  }).attr('fill', 'lightblue');
  svg.selectAll('.temp-text').data(datapoints).enter().append('text').attr('class', 'head').attr('y', height + 40).attr('x', width - 150).text('Source : US Courts Website').style('font-size', 10);
...
},{"d3":"../node_modules/d3/index.js","../data/wiretaps.csv":"data/wiretaps.csv"}]},{},["scripts/wiretap.js"], null)
//# sourceMappingURL=/wiretap.937e1918.js.map